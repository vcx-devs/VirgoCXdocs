...
| Name                                | Type    | Salesforce Key                     | Required | Example                                                              | Description                                                             |
| dispositionTypeCode                 | Integer |                                    | Required | 17                                                                   | See table provide above                                                 |
| dispositionTypeOther                | String  |                                    | Optional | "Test Case"                                                          | If dispositionTypeCode is 11, must provide this value                   |
| **_crypto_**                        | ----    | --------                           | -------- | -------                                                              | -----------                                                             |
...
| **_fiat_**                          | ----    | --------                           | -------- | -------                                                              | -----------                                                             |
| financialInstitutionNumber          | String  | Institution Number                 | Required | "004"                                                                |                                                                         |
| branchNumber                        | String  | Transit Number                     | Required | "13282"                                                              |                                                                         |
| accountNumber                       | String  | Account Number                     | Required | "6119164"                                                            |                                                                         |
...
| accountTypeOther                    | String  |                                    | Optional | "Corporate"                                                          | If type code is 4, must provide this value                              |  
